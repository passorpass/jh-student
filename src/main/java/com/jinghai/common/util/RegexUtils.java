...
public class RegexUtils {
     ...
     * @return 验证成功返回true，验证失败返回false
     */
    public static boolean checkPhoneGH(String phone) {
    ...
    public static void main(String[] args) {
        System.out.println("校验手机号格式：" + checkMobile("13552279651"));
        System.out.println("校验邮箱格式：" + checkEmail("nicaishichoudidi@163.com"));
    }
